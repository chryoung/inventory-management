...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { item_id_id: @price.item_id_id, price: @price.price, record_on: @price.record_on } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { item_id_id: @price.item_id_id, price: @price.price, record_on: @price.record_on } }
