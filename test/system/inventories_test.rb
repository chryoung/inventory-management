...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "should create inventory" do
    ...
    fill_in "Expireon", with: @inventory.ExpireOn
    fill_in "Instockon", with: @inventory.InStockOn
    fill_in "Item", with: @inventory.Item_id
    fill_in "Producedon", with: @inventory.ProducedOn
    fill_in "Quantity", with: @inventory.Quantity
    fill_in "Shelflife", with: @inventory.ShelfLife
    fill_in "Unit", with: @inventory.Unit_id
